...
<body>
<div class="content">
    <div class="section-title">Prodotto ${prodotto.marca} ${prodotto.modello} aggiunto</div>
    <div class="profiles">
        <div class="profile">
            <h3>Prodotto aggiunto al carrello con successo!</h3>
            Vai al <a href="cart-servlet">carrello</a>
        </div>
    </div>
</div>
