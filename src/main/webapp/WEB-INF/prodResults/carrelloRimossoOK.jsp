...
<html>
<head>
    <title>Prodotto rimosso dal carrello</title>
...
<body>
<div class="content">
    <div class="section-title">Prodotto ${prodotto.marca} ${prodotto.modello} rimosso</div>
    <div class="profiles">
        <div class="profile">
            <h3>Prodotto rimosso dal carrello con successo!</h3>
            Ritorna al <a href="cart-servlet">carrello</a>
        </div>
    </div>
</div>
