...
<html>
<head>
    <title>Prodotto già presente</title>
...
<body>
<div class="content">
    <div class="section-title">Prodotto già presente nei preferiti!</div>
    <div class="profiles">
        <div class="profile">
            <h3>Non puoi aggiungere questo prodotto nei preferiti</h3>
            Vai al <a href="cart-servlet">carrello</a><br>
        </div>
    </div>
</div>
