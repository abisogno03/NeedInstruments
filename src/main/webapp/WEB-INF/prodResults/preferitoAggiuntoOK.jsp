<%--@elvariable id="preferiti" type="model.Prodotto"--%>
<%--@elvariable id="prodotto" type="model.Prodotto"--%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@ page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8" language="java" %>
<html>
<head>
    <title>Prodotto aggiunto al carrello</title>
...
<body>
<div class="content">
    <div class="section-title">Prodotto aggiunto ai preferiti</div>
    <div class="profiles">
        <div class="profile">
            <h3>Prodotto <b>${prodotto.marca} ${prodotto.modello}</b> aggiunto ai preferiti con successo!</h3>
            Vai ai <a href="preferiti-servlet">preferiti</a>
        </div>
    </div>
</div>
