...
<html>
<head>
    <title>Prodotto aggiornato</title>
...
<body>
<div class="content">
    <div class="section-title">Prodotto aggiornato</div>
    <div class="profiles">
        <div class="profile">
            <h3>Prodotto aggiornato con successo!</h3>
            Ritorna alla <a href="list-prods-servlet">lista</a><br>
            o vai al <a href="profile-servlet">profilo</a>
        </div>
    </div>
</div>
