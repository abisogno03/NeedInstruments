...
<body>
<div class="content">
    <div class="section-title">Prodotto aggiunto</div>
    <div class="profiles">
        <div class="profile">
            <h3>Prodotto <b>${prodotto.marca} ${prodotto.modello}</b> aggiunto con successo!</h3>
            <a href="new-prod-form">Aggiungi altri prodotti</a><br>
            o vai alla <a href="list-prods-servlet">lista prodotti</a><br>
