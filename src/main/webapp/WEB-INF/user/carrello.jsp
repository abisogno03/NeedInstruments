...
<head>
    ...
    <title>Carrello - NeedInstruments</title>
...
<div class="container">
    <div class="section-title">Il tuo carrello</div><br>
    <div class="content">
        <div class="products">
            <c:choose>
                <c:when test="${not empty listaProdotti}">
                    <form id="cart-form" method="post" action="pagamento-servlet">
                        <c:forEach var="prodotto" items="${listaProdotti}">
                            <div class="product">
                                ...
                                <button type="submit" class="remove-cart" formaction="remove-from-cart-servlet">Rimuovi dal carrello</button>
                            </div>
                        </c:forEach>
                        <br>
                        <button type="submit" class="payment">Procedi all'acquisto</button>
                    </form>
                </c:when>
                <c:otherwise>
                    <p>Non sono presenti prodotti nel carrello. Inizia a cercare per aggiungerne uno.</p>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
