<%--@elvariable id="userToUpdate" type="model.Utente"--%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@ page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8" language="java" %>
<html>
<head>
    <title>Utente aggiunto</title>
...
<body>
<div class="content">
    <div class="section-title">Utente aggiornato</div>
    <div class="profiles">
        <div class="profile">
            <h3>Utente ${userToUpdate.username} aggiornato con successo!</h3>
            <a href="new-user-form">Aggiungi un altro utente</a><br>
            o Vai alla <a href="list-users-servlet">lista utenti</a><br>
