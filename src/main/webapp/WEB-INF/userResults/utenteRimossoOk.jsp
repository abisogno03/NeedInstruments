<%--@elvariable id="username" type="controller"--%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@ page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8" language="java" %>
<html>
<head>
    <title>Utente rimosso</title>
...
<body>
<div class="content">
    <div class="section-title">Utente rimosso</div>
    <div class="profiles">
        <div class="profile"> 
            <h3>Utente <b>${username}</b> rimosso con successo!</h3>
            Ritorna alla <a href="list-users-servlet">lista utenti</a>
        </div>
    </div>
</div>
